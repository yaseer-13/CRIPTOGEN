				...
				<a href={news.url} target='_blank' rel='noreferrer'>
					<div className='rounded overflow-hidden shadow-xl hover:bg-slate-200 text-white  rounded-t-xl rounded-b-xl '>
						...
						<div className='px-6 py-4'>
							<span className='inline-block bg-gray-200 rounded-full px-3 py-1 text-xs uppercase font-semibold justify-center text-gray-900 mb-2'>
						...
						<div className='px-6 pt-4 pb-2 flex justify-center content-center '>
							<span className='inline-block  bg-gray-500 text-gray-200 rounded-full px-3 py-1 text-sm font-semibold  mb-2'>
