    ...
    <>
      ...
      <div>
        ...
        <div className="home-heading-container mt-20 ">
          ...
          <a href="/cryptocurrencies" className="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-sm px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 ">Show More</a>
        </div>
        ...
        <div className="home-heading-container mt-20 ">
          ...
          <a href="/news" className="bg-pink-500 text-white hover:bg-slate-600 font-bold uppercase text-sm px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 ">Show More</a>
        </div>
        <News simplified />
      </div >
    </>
